...
---
New eval (bleuT to change the file name back to bleu when using)
···
python metric_evaluate.py -metric [metric_name] -hyp [output_file] -ref [ground truth]
···
metric_name：chrF, rouge, meteor
···
